	...
	if ((door_id >= 8 and door_id <=12) and (raid.valid or (e.self:Admin() > 80 and e.self:GetGM()))) then
		...
		if (instance_id > 0) then
			...
			if ( phase == "Phase6" ) then
				e.self:MovePCInstance(223, instance_id, 337, 1, 8, 128);
			elseif ( phase == "Phase5" ) then
				e.self:MovePCInstance(223, instance_id, -358, 0, 4, 128);
			elseif ( phase == "Phase4" ) then
				e.self:MovePCInstance(223, instance_id, -382, -11, 349, 124);
			elseif ( phase == "Phase3" ) then
				e.self:MovePCInstance(223, instance_id, 681, 1113, 496, 112);
